...
- 计时器、观察倒计时和成绩统计。
- 支持会话管理，并按当前会话显示次数、最佳、平均、mo3、ao5、ao12、最佳 mo3、最佳 ao5、最佳 ao12、统计详情、最佳单次/滚动平均定位、ao50/ao100 等更多滚动平均、最近成绩、成绩表逐条 ao5/ao12 和 PB/ao50/ao100 刷新标记、成绩趋势图和完整统计摘要复制。
- 历史成绩读取同一个本地 JSON 文件。
