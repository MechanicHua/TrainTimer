...
test('normalizes manually entered solve metadata', async () => {
  ...
  await saveSolve({
    ...
    bluetoothStateLog: [
      {
        step: 1.4,
        facelets: faceletsFromScramble("R'"),
        solved: false,
        trustedSolved: true,
        stateSolved: false,
        source: '0xFFF6',
        protocol: 'gan-v4',
        deviceName: 'Giiker Super Cube',
        ...
        time: '12:00:00',
        isoTime: '2026-05-24T08:15:31.001Z',
        elapsedMs: 121.4,
        timestampMs: 1716538518775,
        solveStartedAtMs: 1716538518654,
        solveStartedAtIsoTime: '2026-05-24T08:15:18.654Z',
      },
      { facelets: 'invalid' },
    ],
...
test('normalizes OP events with per-move timing data', async () => {
  ...
  assert.equal(history.solves[0].opAnalysisVersion, 4);
});
